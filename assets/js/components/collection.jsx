...
const images = ["http://cdn.shopify.com/s/files/1/1022/7525/products/Claska-BowlLargeYellow_2048x2048.jpeg?v=1457662389",
...
export default React.createClass({
  ...
  go(){
    this.timer = setInterval(this.nextImage, 6000);
  },
  nextImage(){
